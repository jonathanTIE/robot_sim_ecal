...
station1 = Station(Position(0, 0, 0))
station2 = Station(Position(1.5, 2.0, 0))
station3 = Station(Position(3.0, 0, 0))
station4 = Station(Position(0.0, 1.0, 0))
...
tri = trilateration_3d_tdoa([
    station1.pos.to_array(), station2.pos.to_array(), station3.pos.to_array(), station4.pos.to_array()], 
    [toa12, toa13, toa14])
